-- ╔══════════════════════════════════════════════════════════╗
-- ║  HazMat Equipment Database Schema                      ║
...
-- Allow public read access (for the design company)
CREATE POLICY "Public read" ON equipment
  FOR SELECT USING (true);

-- Allow authenticated insert/update/delete (admin only via service key)
CREATE POLICY "Service write" ON equipment
  FOR ALL USING (true) WITH CHECK (true);

-- ═══ SEED DATA — all 50 items from the standard ═══

INSERT INTO equipment (id, cat, he, en, qty, st, notes, co, shape) VALUES
...
-- Update dims for items that have them
UPDATE equipment SET dim_l='122', dim_w='61', dim_h='15' WHERE id=42;
UPDATE equipment SET dim_l='167', dim_w='15', dim_h='15' WHERE id=43;
UPDATE equipment SET dim_l='147', dim_w='30', dim_h='30' WHERE id=44;
UPDATE equipment SET dim_l='24.5', dim_w='30.3', dim_h='62.9', wt='4.5' WHERE id=45;
UPDATE equipment SET dim_l='99.1', dim_w='76.2', dim_h='63.5', wt='86.2', url='https://www.hendrickusa.com/steed' WHERE id=46;
UPDATE equipment SET dim_l='86', dim_w='46', dim_h='64', wt='105' WHERE id=47;
UPDATE equipment SET wt='22.7', url='https://spillcontainment.com/products/ultra-spill-deck-flexible-model/' WHERE id=42;
UPDATE equipment SET wt='9' WHERE id=43;
UPDATE equipment SET wt='4' WHERE id=44;
UPDATE equipment SET wt='5' WHERE id=48;
UPDATE equipment SET wt='2' WHERE id=49;
UPDATE equipment SET dim_l='145', dim_w='85', dim_h='7', wt='20' WHERE id=50;
